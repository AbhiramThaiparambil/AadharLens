...
import type { IParseAadhaarAwsUseCase } from './Iparse-aadhaar-aws.usecase.js';
...
@injectable()
export class ParseAadhaarAwsUseCase implements IParseAadhaarAwsUseCase {
  constructor(
    @inject('IImageProcessor')    private readonly _imageProcessor: IImageProcessor,
    @inject('AwsTextractService') private readonly _ocrService:     IOcrService,
